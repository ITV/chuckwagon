...
object VpcConfigDeclarationBuilder {
  implicit def enableVpcConfigDeclarationBuilder(
      builder: VpcConfigDeclarationBuilder[DEFINED, DEFINED, DEFINED]): VpcConfigDeclaration =
    VpcConfigDeclaration(builder.vpcLookupFilters.get,
  ...
  def apply() =
    new VpcConfigDeclarationBuilder[UNDEFINED_VpcLookupFilters,
                                    UNDEFINED_SubnetsLookupFilters,
                                    UNDEFINED_SecurityGroupsLookupFilters](None, None, None)
}

class VpcConfigDeclarationBuilder[B_VPC_LOOKUP_FILTERS, B_SUBNETS_LOOKUP_FILTERS, B_SECURITYGROUPS_LOOKUP_FILTERS](
